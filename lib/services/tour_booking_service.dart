...
class TourBookingService {
  ...
  Future<String> createBooking(
    ...
    String? vehiclePricingRuleId,
    String? commissionPricingRuleId,
    ...
    try {
      ...
      await reference.set(
        <String, dynamic>{
          ...
          // Admin pricing changes after booking must not
          // rewrite the historical booking contract.
          ...
          'providerReceivableAmount': ?providerReceivableAmount,

          if (vehiclePricingRuleId != null &&
              vehiclePricingRuleId.trim().isNotEmpty)
            'vehiclePricingRuleId':
                vehiclePricingRuleId,

          if (commissionPricingRuleId != null &&
              commissionPricingRuleId.trim().isNotEmpty)
  ...
  Future<void> markPaymentPaid(
    ...
    throw StateError(
      'Real tour payment cannot be marked paid from the client. '
