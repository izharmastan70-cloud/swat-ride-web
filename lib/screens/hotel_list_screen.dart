...
class _HotelListScreenState
  ...
  final HotelServiceControlService _serviceControlService =
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<HotelServiceControlModel>(
        stream: _serviceControlService.watchControl(),
        builder: (context, controlSnapshot) {
          if (controlSnapshot.connectionState ==
          ...
          if (controlSnapshot.hasError) {
            return _serviceUnavailableState(
              'Hotel service status is temporarily unavailable. Please try again shortly.',
            );
          }

          final HotelServiceControlModel control =
              controlSnapshot.data ??
                  HotelServiceControlModel.defaults();

          if (!control.isServiceAvailable) {
            return _serviceUnavailableState(
              control.customerUnavailableMessage,
            );
          }
  ...
  Widget _serviceUnavailableState(String message) {
    final String visibleMessage = message.trim().isEmpty
