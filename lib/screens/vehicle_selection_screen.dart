...
class VehicleSelectionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<VehicleModel> vehicles = VehicleData.rideVehicles
      .where((VehicleModel vehicle) => vehicle.id != 'other_vehicle')
          ...
          children: [
            ...
            Container(
              ...
              child: const Row(
                ...
                children: [
                  Icon(Icons.local_taxi_outlined, color: yellow, size: 21),

                  SizedBox(width: 10),

                  Expanded(
                    child: Text(
                      'Select a vehicle to calculate distance, ETA and the latest admin-controlled fare.',
  ...
  Widget _buildNoVehiclesCard() {
    return Container(
      ...
      child: const Column(
        children: [
          Icon(Icons.no_transfer_outlined, color: yellow, size: 42),

          SizedBox(height: 12),

          Text(
            'No ride vehicle is available',
          ...
          Text(
            'Please try again later. The app will remain safe if vehicles are disabled by admin.',
  ...
  void _selectVehicle(BuildContext context, VehicleModel vehicle) {
    // =======================================================
    // OPEN RIDE CONFIRMATION
    // =======================================================
