...
class HotelBookingRequestsScreen
    extends StatefulWidget {
  const HotelBookingRequestsScreen({
    super.key,
  ...
  @override
  State<HotelBookingRequestsScreen>
      createState() =>
...
class _HotelBookingRequestsScreenState
  ...
  final HotelBookingOperationsService
      _bookingService =
  ...
  final String cleanPhone = guestPhone.replaceAll(
    RegExp(r'[^0-9+]'),
    '',
  );

  if (guestPhone == 'Not available' ||
      cleanPhone.isEmpty) {
    _showMessage(
