...
class _TourGuideDashboardScreenState extends State<TourGuideDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        actions: const <Widget>[RewardAccessAction(moduleName: 'tourGuide')],
        backgroundColor: darkBackground,
        elevation: 0,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      guideTypes.isEmpty
                          ? 'Approved Tour Guide'
                          : guideTypes.join(' ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ '),
                      maxLines: 2,
  ...
  void _openUniversalTourGuideSafety(TourBooking booking) {
    final String guideUserId = _currentUser?.uid.trim() ?? '';
    ...
    final List<SafetyPersonSnapshot> relatedPeople = [?customer, ?driver];
    ...
    final SafetyContext safetyContext = SafetyContext(
      serviceType: activeTour
          ...
          : SafetyServiceType.tourGuide,
      referenceId: booking.id,
      initiatedByUserId: guideUserId,
      initiatedByRole: SafetyUserRole.tourGuide,
  ...
  Widget _assignmentActions({
    ...
    final Widget statusActions = _assignmentStatusActions(
      booking: booking,
      applicationId: applicationId,
      guideName: guideName,
    );
    ...
    return Column(
      ...
      children: [
        OutlinedButton.icon(
          onPressed: () => _openUniversalTourGuideSafety(booking),
  ...
  Widget _assignmentStatusActions({
    required TourBooking booking,
    required String applicationId,
    required String guideName,
  }) {
