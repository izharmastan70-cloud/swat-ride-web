...
class AddFoodCategoryScreen extends StatefulWidget {
  ...
  @override
  State<AddFoodCategoryScreen> createState() => _AddFoodCategoryScreenState();
}

class _AddFoodCategoryScreenState extends State<AddFoodCategoryScreen> {
  ...
  void initState() {
    ...
    final RestaurantMenuCategoryModel? category = widget.category;
  ...
  Future<void> _saveCategory() async {
    ...
    try {
      ...
      final RestaurantMenuCategoryModel? existing = widget.category;

      final RestaurantMenuCategoryModel category = RestaurantMenuCategoryModel(
        id: existing?.id ?? '',
      ...
      _showMessage('Unable to save category: $error');
    } finally {
      if (mounted) {
        setState(() {
          _isSaving = false;
    ...
    return _sectionCard(
      ...
      children: <Widget>[
        ...
        TextFormField(
          ...
          decoration: _inputDecoration(
            label: 'Description',
            hint: 'Describe the food items in this category',
  ...
  Widget _buildImageCard() {
    final bool hasImage = _localImagePath.trim().isNotEmpty;
  ...
  Widget _buildSettingsCard() {
    return _sectionCard(
      ...
      children: <Widget>[
        _switchTile(
          title: 'Active',
          subtitle: 'Allow this category to be used in the menu',
        ...
        _switchTile(
          ...
          subtitle: 'Show this category in the customer menu',
        ...
        _switchTile(
          ...
          subtitle: 'Give this category higher priority',
