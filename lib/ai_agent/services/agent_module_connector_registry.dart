...
// =========================================================
// AI AGENT ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â MODULE CONNECTOR REGISTRY
// =========================================================
//
...
class AgentModuleConnectorRegistry {
  ...
  static const Map<String, AgentModuleConnectorDescriptor> _connectors =
    ...
    AgentModuleId.ride: AgentModuleConnectorDescriptor(
      connectorId: 'connector.ride.read_only',
      module: AgentModuleId.ride,
      status: AgentModuleConnectorStatus.readOnlyReady,
      enabled: true,
      readOnlyFirst: true,
      requiresRealModuleAudit: false,
      ...
      notes:
          'Ride audit complete. Exact rideId read-only connector is attached. '
          'Ride writes remain unavailable.',
    ),
    AgentModuleId.driver: AgentModuleConnectorDescriptor(
      connectorId: 'connector.driver.read_only',
      ...
      notes:
          'Driver audit complete. Exact driverId read-only connector '
          'is attached. Driver writes remain unavailable.',
    ),
    AgentModuleId.food: AgentModuleConnectorDescriptor(
      connectorId: 'connector.food.order.read_only',
      ...
      notes:
          'Food order audit complete. Exact orderId read-only connector '
          'is attached. Customer identity, address, OTP, rider identity '
          'and GPS remain hidden. Food writes remain unavailable.',
    ),    AgentModuleId.restaurant: AgentModuleConnectorDescriptor(
      connectorId: 'connector.restaurant.read_only',
      ...
      notes:
          'Restaurant audit complete. Exact restaurantId read-only '
          'connector is attached. Owner identity, contact details, '
          'exact address, GPS, private documents, commission and '
          'admin review data remain hidden. Restaurant writes remain '
          'unavailable.',
    ),
