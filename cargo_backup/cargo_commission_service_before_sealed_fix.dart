...
/// Small adapter used only for backward compatibility when
/// an old booking stores Cargo applicationId as driverId.
class _DriverDocumentAdapter
    implements QueryDocumentSnapshot<Map<String, dynamic>> {
  _DriverDocumentAdapter(this._snapshot);
