...
class CargoHomeScreen extends StatelessWidget {
            ...
            _cargoOption(
              ...
              onTap: () {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text(
                      'Cargo order history will be connected in the next phase.',
                    ),
                  ),
                );
              },
  ...
  void _openVehicleSelection(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => const CargoSelectionScreen(),
      ),
    );
  }
}
