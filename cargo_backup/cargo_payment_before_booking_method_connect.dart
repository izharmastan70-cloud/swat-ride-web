...
class _CargoPaymentScreenState extends State<CargoPaymentScreen> {
  ...
  double get _amountDueNow {
    if (_isBuyForMe) {
      return widget.requiredAdvance;
    }

    return widget.deliveryFare;
  }
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: _selectedMethod == null ? null : _confirmPayment,
  ...
  void _confirmPayment() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          _isBuyForMe
              ? 'Advance payment selected: $method â€” Rs. '
                    '${_amountDueNow.toStringAsFixed(0)}'
              : 'Cargo payment selected: $method â€” Rs. '
                    '${_amountDueNow.toStringAsFixed(0)}',
        ),
      ),
    );
