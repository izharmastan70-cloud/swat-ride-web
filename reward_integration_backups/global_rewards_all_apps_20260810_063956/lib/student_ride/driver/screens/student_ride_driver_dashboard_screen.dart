...
class _StudentRideDriverDashboardScreenState
  ...
  void _openStudentRouteSafety(
    StudentRideRouteModel route,
  ) {
    final bool isMorning =
        route.shift == StudentRideRouteShift.morning;
  ...
  Widget _routeCard(StudentRideRouteModel route) {
    ...
    return Card(
      ...
      child: ExpansionTile(
        ...
        subtitle: Text(
          '${isMorning ? 'Morning' : 'Afternoon'} â€¢ ${route.assignedStudentCount} students',
        ),
