...
class _StudentRideParentDashboardScreenState
  ...
  final StudentRideParentService _parentService =
      StudentRideParentService();
  final StudentRideSubscriptionService _subscriptionService =
      StudentRideSubscriptionService();
  final StudentRideInvoiceService _invoiceService =
      StudentRideInvoiceService();
  final StudentRidePackageService _packageService =
  ...
  Widget _buildSummaryGrid() {
    return Row(
      children: [
        ...
        Expanded(
          child:
              StreamBuilder<List<StudentRideSubscriptionModel>>(
            stream:
                _subscriptionService.watchMySubscriptions(),
            builder: (context, snapshot) {
      ...
      builder: (context, snapshot) {
        if (snapshot.hasError) {
          return const _ErrorCard(
            message: 'Unable to load student profiles.',
          );
        }
        ...
        if (students.isEmpty) {
          return _EmptyCard(
            ...
            message:
                'Add your child profile before selecting a package.',
      ...
      builder: (context, snapshot) {
        ...
        if (subscriptions.isEmpty) {
          return _EmptyCard(
            ...
            message:
                'Choose a Student Ride package after student approval.',
      ...
      builder: (context, snapshot) {
        ...
        if (invoices.isEmpty) {
          return const _EmptyCard(
            ...
            message:
                'Your monthly invoice will appear after route approval.',
          );
        }
      ...
      builder: (context, snapshot) {
        ...
        if (packages.isEmpty) {
          return const _EmptyCard(
            ...
            message:
                'Admin has not enabled a Student Ride package yet.',
          );
        }
  ...
  Widget _buildGuardianCard() {
    return Card(
      ...
      child: ListTile(
        ...
        subtitle: const Text(
          'Manage people allowed to receive your child.',
        ),
...
class _StudentCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final statusColor = switch (student.status) {
      StudentRideStudentStatus.approved =>
        const Color(0xFF18895A),
      StudentRideStudentStatus.rejected =>
        const Color(0xFFD14343),
      StudentRideStudentStatus.suspended =>
        const Color(0xFFD14343),
      StudentRideStudentStatus.draft =>
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: ListTile(
        ...
        subtitle: Text(
          'Billing ${invoice.billingPeriodLabel} • '
